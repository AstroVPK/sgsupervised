...
trainSet = etl.extractTrainSet(cat, inputs=['snrPsf', 'mag', 'ext', 'extHsmDeconv', 'seeing', 'dGaussRadInner', 'dGaussRadRat', 'dGaussAmpRat'], bands=bands, concatBands=concatBands)
if concatBands:
...
for band in bands:
    trainSet = etl.extractTrainSet(cat, inputs=['snrPsf', 'mag', 'ext', 'extHsmDeconv', 'seeing', 'dGaussRadInner', 'dGaussRadRat', 'dGaussAmpRat'], bands=[band])
